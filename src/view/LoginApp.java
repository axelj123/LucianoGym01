...
import controller.ControladorButtonsInterfaces;
import controller.ControladorMenuBar;
...
public class LoginApp extends javax.swing.JFrame {
    ...
    private void btnIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarSesionActionPerformed
        ...
        if (!txtUser.getText().isEmpty() && !txtPass.getText().isEmpty()) {
            ...
            if (us.autenticarUsuario(usuario, contraseña)) {
                // Inicio de sesión exitoso, abre la nueva ventana
                newprincipal np = new newprincipal(); // Crea una instancia de newprincipal
                ControladorMenuBar con = new ControladorMenuBar(np); // Inicializa el controlador pasando la instancia de newprincipal
                np.setVisible(true); // Muestra newprincipal
                ControladorButtonsInterfaces controladorInterfaz = new ControladorButtonsInterfaces(np);
                this.dispose();
            } else {
                // Inicio de sesión fallido, muestra un mensaje de error
                JOptionPane.showMessageDialog(null, "Usuario o contraseña incorrectos", "Inicio de Sesión Fallido", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(null, "Complete todos los campos ", "Inicio Sesion", JOptionPane.INFORMATION_MESSAGE);
        }

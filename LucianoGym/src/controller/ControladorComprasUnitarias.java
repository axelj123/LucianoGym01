 ...
 * @author User
 */
public class ControladorComprasUnitarias implements ActionListener, MouseListener, KeyListener {
    ...
    public ControladorComprasUnitarias(newprincipal np, jdlVentaUnitaria jd) {
        this.np = np;
        this.jd = jd;
        jd.addWindowListener(new WindowAdapter() {
            ...
            public void windowOpened(WindowEvent e) {
                ...
                prdao.listarProductosUnitaros(jd.tblProducs, jd.lblTotal);
            }
        });
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (sourceboton == jd.btnVender) {
            if (!jd.txtCodProductoVenta.getText().isEmpty() && !jd.txtNombreVenta.getText().isEmpty()
        ...
        if (tableclick == jd.tblProducs) {
            if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 1) {
                ...
                if ((fila > -1) && (columna > -1)) {
                    ...
                    jd.txtNombreVenta.setText(String.valueOf(pr.getNombre()));
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (text == jd.txtCantidadVenta) {
            ...
            try {
                ...
                if (fila >= 0) {
                    ...
                    int stock = Integer.parseInt(jd.tblProducs.getValueAt(fila, 5).toString());
        ...
        if (text == jd.txtBuscarPorcProduct) {
            ...
            pr.setNombre(valor);
            prdao.buscarProductosPorNombre(pr, jd.tblProducs, jd.lblTotal);
        }
    }
